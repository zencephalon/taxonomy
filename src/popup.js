...
document.addEventListener('DOMContentLoaded', function () {
  // dumpBookmarks();
  chrome.bookmarks.search("Lifehacking", function (array) { console.log(array) })
  chrome.bookmarks.getTree(function (array) { console.log(array) })
  Mousetrap.bind('space a a', function() { console.log("aa") })
  Mousetrap.bind('space a b', function() { console.log("ab") })
});
